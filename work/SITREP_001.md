...
This is first news post. 
Currently there is not enough content to fill a whole post but we try to collect as much stuff as possible. 
Additionally we experiment on the layout of this post.

On a new paragraph we can tell ou more about another topic unrelated to the stuff above. Markdown is awesome and easy to understand for everyone.
